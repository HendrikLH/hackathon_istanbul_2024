...
import {mockAwbData, mockQAOverview } from "./mockData";
  ...
  return (
    <>
      ...
      <Card margin="1em 0" width="100%" boxSizing="border-box">
        <CardHeader>
        <Heading size="md">Shipment Details - AWB 44395433</Heading>
        ...
        <CardBody>
          <SimpleGrid columns={[2, null, 3]} spacing={4}>
            ...
            <Flex align="center">
              <Icon as={FaBox} mr={2} />
              <Text>Customs: Cleared</Text>
            </Flex>
            <Flex align="center">
              <Icon as={FaFlag} mr={2} />
              <Text>Screening: Pending</Text>
            </Flex>
          </SimpleGrid>
        </CardBody>
      </Card>
