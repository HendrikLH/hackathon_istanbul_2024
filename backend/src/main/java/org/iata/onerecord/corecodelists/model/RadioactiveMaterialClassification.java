 ...
 * 
 */
@OWLClass(iri = Vocabulary.s_c_RadioactiveMaterialClassification )
@SuperBuilder
@EqualsAndHashCode
public class RadioactiveMaterialClassification
    implements Serializable
{
    ...
    public String toString() {
        return ((((("RadioactiveMaterialClassification {"+ name)+"<")+ id)+">")+"}");
    }
