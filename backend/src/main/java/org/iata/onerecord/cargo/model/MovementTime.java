    ...
    implements Serializable
{
     ...
     * 
     */
    @OWLObjectProperty(iri = Vocabulary.s_p_direction)
     ...
     * 
     */
    @OWLObjectProperty(iri = Vocabulary.s_p_movementMilestone)
    @ParticipationConstraints({
        @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Thing, max = 1)
    })
    protected MovementIndicator movementMilestone;
    /**
     * The type of time can be Actual, Estimated ot Scheduled
     * 
     */
    @OWLObjectProperty(iri = Vocabulary.s_p_movementTimeType)
    @ParticipationConstraints({
        @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Thing, max = 1)
    })
    protected MovementTimeType movementTimeType;
    /**
    ...
    public void setMovementMilestone(MovementIndicator movementMilestone) {
        this.movementMilestone = movementMilestone;
    }

    public MovementIndicator getMovementMilestone() {
        return movementMilestone;
    }

    public void setMovementTimeType(MovementTimeType movementTimeType) {
        this.movementTimeType = movementTimeType;
    }

    public MovementTimeType getMovementTimeType() {
