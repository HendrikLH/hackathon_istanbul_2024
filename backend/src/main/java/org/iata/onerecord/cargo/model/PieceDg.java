    ...
    implements Serializable
{
     ...
     * 
     */
    @OWLObjectProperty(iri = Vocabulary.s_p_overpackTypeCode)
    @ParticipationConstraints({
        @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Thing, max = 1)
    })
    protected CodeListElement overpackTypeCode;
    /**
    ...
    public void setOverpackTypeCode(CodeListElement overpackTypeCode) {
        this.overpackTypeCode = overpackTypeCode;
    }

    public CodeListElement getOverpackTypeCode() {
