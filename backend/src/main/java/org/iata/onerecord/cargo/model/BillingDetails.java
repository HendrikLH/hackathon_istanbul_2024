    ...
    extends LogisticsObject
{
     ...
     * 
     */
    @OWLObjectProperty(iri = Vocabulary.s_p_awbUseIndicator)
    @ParticipationConstraints({
        @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Thing, max = 1)
    })
    protected AWBUseIndicator awbUseIndicator;
    /**
    ...
    protected CurrencyValue taxDueAgent;
    /**
    ...
    protected CurrencyValue taxDueAirline;
    /**
    ...
    public void setAwbUseIndicator(AWBUseIndicator awbUseIndicator) {
        this.awbUseIndicator = awbUseIndicator;
    }

    public AWBUseIndicator getAwbUseIndicator() {
    ...
    public void setTaxDueAgent(CurrencyValue taxDueAgent) {
        this.taxDueAgent = taxDueAgent;
    }

    public CurrencyValue getTaxDueAgent() {
        return taxDueAgent;
    }

    public void setTaxDueAirline(CurrencyValue taxDueAirline) {
        this.taxDueAirline = taxDueAirline;
    }

    public CurrencyValue getTaxDueAirline() {
